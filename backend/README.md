...
## Project Structure
    ...
    ├── tst_daniel_databind_37854  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_databind_37854`
...
2. Clone this repo and `cd tst_daniel_databind_37854`
